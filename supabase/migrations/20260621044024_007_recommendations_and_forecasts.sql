/*
# Phase 9 & 10: Recommendations and Forecasting Tables

1. New Tables
- `campaign_recommendations`: Stores AI-generated scaling recommendations per campaign
- `campaign_forecasts`: Stores predicted future performance per campaign
...
DROP POLICY IF EXISTS "select_own_recommendations" ON campaign_recommendations;
...
DROP POLICY IF EXISTS "insert_own_recommendations" ON campaign_recommendations;
...
DROP POLICY IF EXISTS "update_own_recommendations" ON campaign_recommendations;
...
DROP POLICY IF EXISTS "delete_own_recommendations" ON campaign_recommendations;
...
DROP POLICY IF EXISTS "select_own_forecasts" ON campaign_forecasts;
...
DROP POLICY IF EXISTS "insert_own_forecasts" ON campaign_forecasts;
...
DROP POLICY IF EXISTS "update_own_forecasts" ON campaign_forecasts;
...
DROP POLICY IF EXISTS "delete_own_forecasts" ON campaign_forecasts;
